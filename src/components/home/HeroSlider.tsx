...
const videoSlides: VideoSlide[] = [
  ...
  {
    video: "/videos/hero/optimized/ocean-waves.mp4",
    poster: "/videos/hero/optimized/ocean-waves-poster.webp",
    subtitle: "Doğanın Gücü",
    title: "Saf Temizlik",
    buttonText: "Ürünleri Keşfet",
    buttonLink: "/erkek-ic-giyim",
  },
  {
    video: "/videos/hero/optimized/golden-sunset.mp4",
    poster: "/videos/hero/optimized/golden-sunset-poster.webp",
    subtitle: "Her Güne Yeni Başlangıç",
    title: "Altın Konfor",
    buttonText: "Koleksiyonu Gör",
    buttonLink: "/kadin-ic-giyim",
  },
  {
    video: "/videos/hero/optimized/harvest-field.mp4",
    poster: "/videos/hero/optimized/harvest-field-poster.webp",
    subtitle: "Tarladan Teninize",
    title: "Pamuk Hasadı",
    buttonText: "Hikayemiz",
    buttonLink: "/hakkimizda",
  },
  {
    video: "/videos/hero/optimized/sewing-detail.mp4",
    poster: "/videos/hero/optimized/sewing-detail-poster.webp",
    subtitle: "Titiz İşçilik",
    title: "El Emeği",
    buttonText: "Üretim Süreci",
    buttonLink: "/hakkimizda",
  },
  {
    video: "/videos/hero/optimized/silk-weave.mp4",
    poster: "/videos/hero/optimized/silk-weave-poster.webp",
    subtitle: "190 GSM Penye",
    title: "İpek Doku",
    buttonText: "Kumaş Detayları",
    buttonLink: "/erkek-ic-giyim",
  },
  {
    video: "/videos/hero/optimized/water-stream.mp4",
    poster: "/videos/hero/optimized/water-stream-poster.webp",
    subtitle: "Kristal Berraklık",
    title: "Doğal Akış",
